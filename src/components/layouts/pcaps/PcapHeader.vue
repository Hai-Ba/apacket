...
<div class="content_box">
    <a-collapse v-model:activeKey="activeKey" :bordered="false" :pagination="{
...
export default defineComponent({
    setup() {
        ...
        const customStyle = 'background: #32373A;border-radius: 4px;margin-bottom: 24px;border: 0;overflow: hidden;color: #fff!important;';
        const httpHeader = [{
        ...
        return {
            ...
            httpHeader,
            current: ref(1),
            pageTotal: ref(httpHeader.length),
        }
    },
})
</script>
