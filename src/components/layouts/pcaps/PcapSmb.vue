...
<div class="smb_tab">
    <a-tabs v-model:activeKey="activeKey">
        <a-tab-pane key="1" tab="SBM Hot Announces (1)">
        ...
        <a-tab-pane key="2" tab="SBM Auth (0)" force-render>
            <div style="background-color: #32373A;"><a-empty/></div>
        </a-tab-pane>
    </a-tabs>
</div>
</template>
